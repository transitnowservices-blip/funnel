 ...
 *   (Phase 5 placeholder — always 0 until Phase 5 wires it, honestly labeled).
 *
...
const VIDEO_SESSIONS_NOTE =
  'Coming in Phase 5. This count reads the live_sessions table directly and ' +
  'stays 0 until Phase 5 wires real sessions — it is never estimated or faked.';
...
async function getCommandMetrics(raw = {}) {
  ...
  const [
    ...
    // Phase 5 placeholder: reads the real table, which is empty until then.
