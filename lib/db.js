...
const SCHEMA_STATEMENTS = [
  ...
  // Placeholder for Phase 5 live video (spec section 15). The table exists
  // so the command center queries it honestly; nothing can create a live
  // session yet, so the count is always 0 with a "coming in Phase 5" note.
